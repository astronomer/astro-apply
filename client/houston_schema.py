...
class MetricType(sgqlc.types.Enum):
    ...
    * `DEPLOYMENT_USAGE`None
    '''
    __schema__ = houston_schema
    __choices__ = ('DEPLOYMENT_STATUS', 'DEPLOYMENT_TASKS', 'DEPLOYMENT_DATABASE', 'DEPLOYMENT_SCHEDULER', 'DEPLOYMENT_QUOTAS', 'DEPLOYMENT_USAGE')
...
class Role(sgqlc.types.Enum):
    ...
    * `USER`None
    '''
    __schema__ = houston_schema
    __choices__ = ('SYSTEM_ADMIN', 'SYSTEM_EDITOR', 'SYSTEM_VIEWER', 'WORKSPACE_ADMIN', 'WORKSPACE_EDITOR', 'WORKSPACE_VIEWER', 'DEPLOYMENT_ADMIN', 'DEPLOYMENT_EDITOR', 'DEPLOYMENT_VIEWER', 'USER')
...
class UserSearch(sgqlc.types.Input):
    __schema__ = houston_schema
    __field_names__ = ('user_id', 'user_uuid', 'username', 'email', 'full_name', 'created_at', 'updated_at')
...
class Webserver(sgqlc.types.Input):
    ...
    use_default_airflow_image = sgqlc.types.Field(Boolean, graphql_name='useDefaultAirflowImage')
...
class Workers(sgqlc.types.Input):
    ...
    termination_grace_period_seconds = sgqlc.types.Field(Int, graphql_name='terminationGracePeriodSeconds')
...
class AirflowRelease(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('tag', 'version', 'url', 'level', 'description', 'release_date', 'channel')
    ...
    release_date = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='releaseDate')
...
class AppConfig(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('version', 'base_domain', 'smtp_configured', 'manual_release_names', 'prometheus_enabled', 'elastic_search_enabled')
    version = sgqlc.types.Field(String, graphql_name='version')
    ...
    elastic_search_enabled = sgqlc.types.Field(Boolean, graphql_name='elasticSearchEnabled')
...
class AstroUnit(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('cpu', 'memory', 'pods', 'airflow_conns', 'actual_conns', 'price')
    cpu = sgqlc.types.Field(Int, graphql_name='cpu')
...
class AuthConfig(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('public_signup', 'external_signup_url', 'initial_signup', 'local_enabled', 'providers')
    ...
    providers = sgqlc.types.Field(sgqlc.types.list_of('AuthProvider'), graphql_name='providers')
...
class AuthUser(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('user', 'token', 'permissions', 'is_admin', 'auth_user_capabilities')
    ...
    auth_user_capabilities = sgqlc.types.Field('AuthUserCapabilities', graphql_name='authUserCapabilities')
...
class Card(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('name', 'exp_month', 'exp_year', 'last4', 'brand', 'billing_email', 'company')
    name = sgqlc.types.Field(String, graphql_name='name')
...
class Deployment(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('id', 'executor', 'workers', 'webserver', 'scheduler', 'config', 'environment_variables', 'properties', 'urls', 'alert_emails', 'description', 'label', 'release_name', 'status', 'type', 'version', 'airflow_version', 'desired_airflow_version', 'deploy_info', 'deployment_status', 'workspace', 'created_at', 'updated_at', 'role_bindings', 'deployment_capabilities', 'service_accounts')
    ...
    environment_variables = sgqlc.types.Field(sgqlc.types.list_of('EnvironmentVariable'), graphql_name='environmentVariables')
    ...
    alert_emails = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))), graphql_name='alertEmails')
    ...
    desired_airflow_version = sgqlc.types.Field(String, graphql_name='desiredAirflowVersion')
    ...
    role_bindings = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null('RoleBinding'))), graphql_name='roleBindings')
    '''A list of `RoleBinding`s attached to the `Deployment`. This
    determines who has access on the `Deployment`.
    '''

    deployment_capabilities = sgqlc.types.Field('DeploymentCapabilities', graphql_name='deploymentCapabilities')
    '''An object containing various `Boolean`s indicating what the
    current user can access in relation to the `Deployment`.
    '''

    service_accounts = sgqlc.types.Field(sgqlc.types.list_of('ServiceAccount'), graphql_name='serviceAccounts')
...
class DeploymentCapabilities(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('can_deploy', 'can_update_deployment', 'can_delete_deployment', 'can_create_service_account', 'can_update_service_account', 'can_delete_service_account', 'can_update_variables', 'can_update_user_role')
    can_deploy = sgqlc.types.Field(Boolean, graphql_name='canDeploy')
    '''Can the current user deploy code to the `Deployment`?'''

    can_update_deployment = sgqlc.types.Field(Boolean, graphql_name='canUpdateDeployment')
    '''Can the current user update the `Deployment`?'''

    can_delete_deployment = sgqlc.types.Field(Boolean, graphql_name='canDeleteDeployment')
    '''Can the current user delete the `Deployment`?'''

    can_create_service_account = sgqlc.types.Field(Boolean, graphql_name='canCreateServiceAccount')
    '''Can the current user create a `ServiceAccount` for the
    `Deployment`?
    '''

    can_update_service_account = sgqlc.types.Field(Boolean, graphql_name='canUpdateServiceAccount')
    '''Can the current user update a `ServiceAccount` in the
    `Deployment`?
    '''

    can_delete_service_account = sgqlc.types.Field(Boolean, graphql_name='canDeleteServiceAccount')
...
class DeploymentConfig(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('defaults', 'limits', 'astro_unit', 'max_extra_au', 'executors', 'single_namespace', 'logging_enabled', 'latest_version', 'airflow_images', 'airflow_versions', 'default_airflow_image_tag', 'default_airflow_chart_version')
    ...
    airflow_images = sgqlc.types.Field(sgqlc.types.list_of(AirflowImage), graphql_name='airflowImages')

    airflow_versions = sgqlc.types.Field(JSON, graphql_name='airflowVersions')

    default_airflow_image_tag = sgqlc.types.Field(String, graphql_name='defaultAirflowImageTag')

    default_airflow_chart_version = sgqlc.types.Field(String, graphql_name='defaultAirflowChartVersion')
...
class DockerImage(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('id', 'name', 'labels', 'env', 'tag', 'digest', 'deployment', 'created_at')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
...
class Email(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('id', 'address', 'primary', 'token', 'user', 'verified', 'created_at', 'updated_at')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
...
class Invite(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('id', 'uuid', 'assignments', 'role', 'email', 'token', 'created_at', 'updated_at')
    id = sgqlc.types.Field(String, graphql_name='id')
...
class LocalCredential(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('id', 'user', 'password', 'reset_token', 'created_at', 'updated_at')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
...
class Mutation(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('create_user', 'confirm_email', 'create_token', 'forgot_password', 'resend_confirmation', 'reset_password', 'create_deployment', 'update_deployment', 'update_deployment_keda_config', 'update_deployment_airflow', 'deployment_alerts_update', 'deployment_add_user_role', 'deployment_remove_user_role', 'deployment_update_user_role', 'delete_deployment', 'delete_workspace', 'update_self', 'remove_user', 'create_workspace', 'workspace_add_user', 'workspace_update_user_role', 'workspace_remove_user', 'delete_invite_token', 'update_workspace', 'upgrade_deployment', 'create_service_account', 'create_deployment_service_account', 'create_workspace_service_account', 'create_system_service_account', 'update_service_account', 'update_workspace_service_account', 'update_deployment_service_account', 'delete_service_account', 'delete_workspace_service_account', 'delete_deployment_service_account', 'delete_system_service_account', 'update_deployment_variables', 'create_system_role_binding', 'delete_system_role_binding', 'invite_user', 'add_card', 'add_customer_id', 'update_card', 'suspend_workspace', 'extend_workspace_trial', 'verify_email')
    create_user = sgqlc.types.Field(AuthUser, graphql_name='createUser', args=sgqlc.types.ArgDict((
        ...
        ('profile', sgqlc.types.Arg(JSON, graphql_name='profile', default=None)),
        ('invite_token', sgqlc.types.Arg(String, graphql_name='inviteToken', default=None)),
    ...
    * `duration` (`Int`)None
    ...
    confirm_email = sgqlc.types.Field(AuthUser, graphql_name='confirmEmail', args=sgqlc.types.ArgDict((
    ...
    * `duration` (`Int`)None
    ...
    create_token = sgqlc.types.Field(AuthUser, graphql_name='createToken', args=sgqlc.types.ArgDict((
        ('password', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='password', default=None)),
        ('identity', sgqlc.types.Arg(String, graphql_name='identity', default=None)),
        ('duration', sgqlc.types.Arg(Int, graphql_name='duration', default=None)),
))
    )
    '''Arguments:
    ...
    * `duration` (`Int`)None
    ...
    forgot_password = sgqlc.types.Field(Boolean, graphql_name='forgotPassword', args=sgqlc.types.ArgDict((
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
))
    )
    '''Arguments:
    ...
    * `email` (`String!`)None
    ...
    resend_confirmation = sgqlc.types.Field(Boolean, graphql_name='resendConfirmation', args=sgqlc.types.ArgDict((
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
))
    )
    '''Arguments:
    ...
    * `email` (`String!`)None
    ...
    reset_password = sgqlc.types.Field(AuthUser, graphql_name='resetPassword', args=sgqlc.types.ArgDict((
        ('token', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='token', default=None)),
        ('password', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='password', default=None)),
        ('duration', sgqlc.types.Arg(Int, graphql_name='duration', default=None)),
))
    ...
    * `duration` (`Int`)None
    ...
    create_deployment = sgqlc.types.Field(Deployment, graphql_name='createDeployment', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('release_name', sgqlc.types.Arg(String, graphql_name='releaseName', default=None)),
        ...
        ('airflow_version', sgqlc.types.Arg(String, graphql_name='airflowVersion', default=None)),
        ('executor', sgqlc.types.Arg(ExecutorType, graphql_name='executor', default=None)),
        ('workers', sgqlc.types.Arg(Workers, graphql_name='workers', default=None)),
        ('webserver', sgqlc.types.Arg(Webserver, graphql_name='webserver', default=None)),
        ('scheduler', sgqlc.types.Arg(Scheduler, graphql_name='scheduler', default=None)),
        ('config', sgqlc.types.Arg(JSON, graphql_name='config', default=None)),
        ('properties', sgqlc.types.Arg(JSON, graphql_name='properties', default=None)),
        ('cloud_role', sgqlc.types.Arg(String, graphql_name='cloudRole', default=None)),
))
    )
    '''Arguments:
    ...
    * `cloud_role` (`String`)None
    ...
    update_deployment = sgqlc.types.Field(Deployment, graphql_name='updateDeployment', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
    ...
    * `cloud_role` (`String`)None
    ...
    update_deployment_keda_config = sgqlc.types.Field(Deployment, graphql_name='updateDeploymentKedaConfig', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('state', sgqlc.types.Arg(sgqlc.types.non_null(Boolean), graphql_name='state', default=None)),
))
    )
    '''Arguments:
    ...
    * `state` (`Boolean!`)None
    ...
    update_deployment_airflow = sgqlc.types.Field(Deployment, graphql_name='updateDeploymentAirflow', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('desired_airflow_version', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='desiredAirflowVersion', default=None)),
))
    )
    '''Arguments:
    ...
    * `desired_airflow_version` (`String!`)None
    ...
    deployment_alerts_update = sgqlc.types.Field(Deployment, graphql_name='deploymentAlertsUpdate', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('alert_emails', sgqlc.types.Arg(sgqlc.types.list_of(String), graphql_name='alertEmails', default=None)),
))
    )
    '''Arguments:
    ...
    * `alert_emails` (`[String]`)None
    ...
    deployment_add_user_role = sgqlc.types.Field('RoleBinding', graphql_name='deploymentAddUserRole', args=sgqlc.types.ArgDict((
        ('user_id', sgqlc.types.Arg(Id, graphql_name='userId', default=None)),
        ('deployment_id', sgqlc.types.Arg(sgqlc.types.non_null(Id), graphql_name='deploymentId', default=None)),
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
    ...
    * `role` (`Role!`)None
    ...
    deployment_remove_user_role = sgqlc.types.Field('RoleBinding', graphql_name='deploymentRemoveUserRole', args=sgqlc.types.ArgDict((
        ('user_id', sgqlc.types.Arg(Id, graphql_name='userId', default=None)),
        ('deployment_id', sgqlc.types.Arg(sgqlc.types.non_null(Id), graphql_name='deploymentId', default=None)),
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
))
    ...
    * `email` (`String!`)None
    ...
    deployment_update_user_role = sgqlc.types.Field('RoleBinding', graphql_name='deploymentUpdateUserRole', args=sgqlc.types.ArgDict((
        ('user_id', sgqlc.types.Arg(Id, graphql_name='userId', default=None)),
        ('deployment_id', sgqlc.types.Arg(sgqlc.types.non_null(Id), graphql_name='deploymentId', default=None)),
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default=None)),
    ...
    * `role` (`Role!`)None
    ...
    delete_deployment = sgqlc.types.Field(Deployment, graphql_name='deleteDeployment', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
))
    )
    '''Arguments:
    ...
    * `deployment_uuid` (`Uuid!`)None
    ...
    delete_workspace = sgqlc.types.Field('Workspace', graphql_name='deleteWorkspace', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
))
    )
    '''Arguments:
    ...
    * `workspace_uuid` (`Uuid!`)None
    ...
    update_self = sgqlc.types.Field('User', graphql_name='updateSelf', args=sgqlc.types.ArgDict((
    ...
    * `payload` (`JSON!`)None
    ...
    remove_user = sgqlc.types.Field('User', graphql_name='removeUser', args=sgqlc.types.ArgDict((
        ('user_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='userUuid', default=None)),
))
    )
    '''Arguments:
    ...
    * `user_uuid` (`Uuid!`)None
    ...
    create_workspace = sgqlc.types.Field('Workspace', graphql_name='createWorkspace', args=sgqlc.types.ArgDict((
        ('label', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='label', default=None)),
        ('description', sgqlc.types.Arg(String, graphql_name='description', default=None)),
))
    )
    ...
    * `description` (`String`)None
    ...
    workspace_add_user = sgqlc.types.Field('Workspace', graphql_name='workspaceAddUser', args=sgqlc.types.ArgDict((
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
        ('workspace_uuid', sgqlc.types.Arg(Uuid, graphql_name='workspaceUuid', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default='WORKSPACE_VIEWER')),
        ('deployment_roles', sgqlc.types.Arg(sgqlc.types.list_of(DeploymentRoles), graphql_name='deploymentRoles', default=None)),
))
    )
    '''Arguments:
    ...
    * `deployment_roles` (`[DeploymentRoles]`)None
    ...
    workspace_update_user_role = sgqlc.types.Field(Role, graphql_name='workspaceUpdateUserRole', args=sgqlc.types.ArgDict((
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default=None)),
))
    ...
    * `role` (`Role!`)None
    ...
    workspace_remove_user = sgqlc.types.Field('Workspace', graphql_name='workspaceRemoveUser', args=sgqlc.types.ArgDict((
        ('user_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='userUuid', default=None)),
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
))
    )
    ...
    * `workspace_uuid` (`Uuid!`)None
    ...
    delete_invite_token = sgqlc.types.Field(Invite, graphql_name='deleteInviteToken', args=sgqlc.types.ArgDict((
        ('invite_uuid', sgqlc.types.Arg(Uuid, graphql_name='inviteUuid', default=None)),
        ('workspace_uuid', sgqlc.types.Arg(Uuid, graphql_name='workspaceUuid', default=None)),
))
    )
    '''Arguments:
    ...
    * `workspace_uuid` (`Uuid`)None
    ...
    update_workspace = sgqlc.types.Field('Workspace', graphql_name='updateWorkspace', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('payload', sgqlc.types.Arg(sgqlc.types.non_null(JSON), graphql_name='payload', default=None)),
))
    )
    ...
    * `payload` (`JSON!`)None
    ...
    upgrade_deployment = sgqlc.types.Field(Deployment, graphql_name='upgradeDeployment', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('version', sgqlc.types.Arg(String, graphql_name='version', default=None)),
))
    )
    ...
    * `version` (`String`)None
    ...
    create_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='createServiceAccount', args=sgqlc.types.ArgDict((
        ('label', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='label', default=None)),
        ('category', sgqlc.types.Arg(String, graphql_name='category', default=None)),
        ('entity_type', sgqlc.types.Arg(sgqlc.types.non_null(EntityType), graphql_name='entityType', default=None)),
        ('entity_uuid', sgqlc.types.Arg(Uuid, graphql_name='entityUuid', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default=None)),
))
    )
    '''Arguments:
    ...
    * `role` (`Role!`)None
    ...
    create_deployment_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='createDeploymentServiceAccount', args=sgqlc.types.ArgDict((
        ('label', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='label', default=None)),
        ('category', sgqlc.types.Arg(String, graphql_name='category', default=None)),
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default=None)),
    ...
    * `role` (`Role!`)None
    ...
    create_workspace_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='createWorkspaceServiceAccount', args=sgqlc.types.ArgDict((
        ('label', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='label', default=None)),
        ('category', sgqlc.types.Arg(String, graphql_name='category', default=None)),
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default=None)),
    ...
    * `role` (`Role!`)None
    ...
    create_system_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='createSystemServiceAccount', args=sgqlc.types.ArgDict((
        ('label', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='label', default=None)),
        ('category', sgqlc.types.Arg(String, graphql_name='category', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default=None)),
))
    ...
    * `role` (`Role!`)None
    ...
    update_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='updateServiceAccount', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
        ('payload', sgqlc.types.Arg(JSON, graphql_name='payload', default=None)),
))
    )
    '''Arguments:
    ...
    * `payload` (`JSON`)None
    ...
    update_workspace_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='updateWorkspaceServiceAccount', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('payload', sgqlc.types.Arg(sgqlc.types.non_null(JSON), graphql_name='payload', default=None)),
))
    ...
    * `payload` (`JSON!`)None
    ...
    update_deployment_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='updateDeploymentServiceAccount', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('payload', sgqlc.types.Arg(JSON, graphql_name='payload', default=None)),
))
    ...
    * `payload` (`JSON`)None
    ...
    delete_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='deleteServiceAccount', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
))
    )
    '''Arguments:
    ...
    * `service_account_uuid` (`Uuid!`)None
    ...
    delete_workspace_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='deleteWorkspaceServiceAccount', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
))
    )
    ...
    * `workspace_uuid` (`Uuid!`)None
    ...
    delete_deployment_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='deleteDeploymentServiceAccount', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
))
    )
    ...
    * `deployment_uuid` (`Uuid!`)None
    ...
    delete_system_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='deleteSystemServiceAccount', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
))
    )
    '''Arguments:
    ...
    * `service_account_uuid` (`Uuid!`)None
    ...
    update_deployment_variables = sgqlc.types.Field(sgqlc.types.list_of(EnvironmentVariable), graphql_name='updateDeploymentVariables', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('release_name', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='releaseName', default=None)),
        ('environment_variables', sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(InputEnvironmentVariable)), graphql_name='environmentVariables', default=None)),
))
    )
    '''Arguments:
    ...
    * `environment_variables` (`[InputEnvironmentVariable]!`)None
    ...
    create_system_role_binding = sgqlc.types.Field('RoleBinding', graphql_name='createSystemRoleBinding', args=sgqlc.types.ArgDict((
    ...
    * `role` (`Role!`)None
    ...
    delete_system_role_binding = sgqlc.types.Field('RoleBinding', graphql_name='deleteSystemRoleBinding', args=sgqlc.types.ArgDict((
        ('user_id', sgqlc.types.Arg(sgqlc.types.non_null(ID), graphql_name='userId', default=None)),
        ('role', sgqlc.types.Arg(sgqlc.types.non_null(Role), graphql_name='role', default=None)),
))
    )
    ...
    * `role` (`Role!`)None
    ...
    invite_user = sgqlc.types.Field(Invite, graphql_name='inviteUser', args=sgqlc.types.ArgDict((
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
))
    )
    '''Arguments:
    ...
    * `email` (`String!`)None
    ...
    add_card = sgqlc.types.Field(Card, graphql_name='addCard', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('billing_email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='billingEmail', default=None)),
        ('company', sgqlc.types.Arg(String, graphql_name='company', default=None)),
        ('token', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='token', default=None)),
))
    )
    '''Arguments:
    ...
    * `token` (`String!`)None
    ...
    add_customer_id = sgqlc.types.Field('Workspace', graphql_name='addCustomerId', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
    ...
    * `stripe_customer_id` (`String!`)None
    ...
    update_card = sgqlc.types.Field(Card, graphql_name='updateCard', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('billing_email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='billingEmail', default=None)),
        ('company', sgqlc.types.Arg(String, graphql_name='company', default=None)),
        ('token', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='token', default=None)),
    ...
    * `token` (`String!`)None
    ...
    suspend_workspace = sgqlc.types.Field('Workspace', graphql_name='suspendWorkspace', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('is_suspended', sgqlc.types.Arg(sgqlc.types.non_null(Boolean), graphql_name='isSuspended', default=None)),
))
    )
    '''Arguments:
    ...
    * `is_suspended` (`Boolean!`)None
    ...
    extend_workspace_trial = sgqlc.types.Field('Workspace', graphql_name='extendWorkspaceTrial', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('extra_days', sgqlc.types.Arg(sgqlc.types.non_null(Int), graphql_name='extraDays', default=None)),
))
    )
    '''Arguments:
    ...
    * `extra_days` (`Int!`)None
    ...
    verify_email = sgqlc.types.Field(Boolean, graphql_name='verifyEmail', args=sgqlc.types.ArgDict((
        ('email', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='email', default=None)),
))
    )
    '''Arguments:
...
class Query(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('email', 'workspace', 'deployment', 'airflow_release', 'auth_config', 'app_config', 'self', 'deployment_config', 'workspaces', 'update_available', 'users', 'deployments', 'deployment_users', 'deployment_variables', 'invites', 'airflow_releases', 'card', 'workspace_invites', 'workspace_deployments', 'workspace_deployment', 'service_accounts', 'workspace_service_accounts', 'workspace_service_account', 'workspace_users', 'workspace_user', 'deployment_service_account', 'deployment_service_accounts', 'logs')
    email = sgqlc.types.Field(Email, graphql_name='email', args=sgqlc.types.ArgDict((
        ('where', sgqlc.types.Arg(sgqlc.types.non_null(EmailWhereUniqueInput), graphql_name='where', default=None)),
))
    )
    '''Arguments:
    ...
    * `workspace_uuid` (`Uuid!`)None
    ...
    deployment = sgqlc.types.Field(Deployment, graphql_name='deployment', args=sgqlc.types.ArgDict((
        ('where', sgqlc.types.Arg(sgqlc.types.non_null(DeploymentWhereUniqueInput), graphql_name='where', default=None)),
))
    )
    '''Arguments:
    ...
    * `where` (`DeploymentWhereUniqueInput!`)None
    ...
    airflow_release = sgqlc.types.Field(AirflowRelease, graphql_name='airflowRelease', args=sgqlc.types.ArgDict((
        ('where', sgqlc.types.Arg(sgqlc.types.non_null(AirflowReleaseWhereUniqueInput), graphql_name='where', default=None)),
))
    )
    '''Arguments:
    ...
    * `where` (`AirflowReleaseWhereUniqueInput!`)None
    ...
    auth_config = sgqlc.types.Field(AuthConfig, graphql_name='authConfig', args=sgqlc.types.ArgDict((
        ('redirect', sgqlc.types.Arg(String, graphql_name='redirect', default=None)),
        ('duration', sgqlc.types.Arg(Int, graphql_name='duration', default=None)),
    ...
    * `invite_token` (`String`)None
    ...
    deployment_config = sgqlc.types.Field(DeploymentConfig, graphql_name='deploymentConfig', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(Uuid, graphql_name='workspaceUuid', default=None)),
        ('deployment_uuid', sgqlc.types.Arg(Uuid, graphql_name='deploymentUuid', default=None)),
    ...
    * `version` (`String`): The version of deployment.
    ...
    workspaces = sgqlc.types.Field(sgqlc.types.list_of('Workspace'), graphql_name='workspaces')
    '''The `workspaces` query returns a list of `Workspace`s that the
    current user has access to.
    '''

    update_available = sgqlc.types.Field(PlatformRelease, graphql_name='updateAvailable')
    ...
    * `user` (`UserSearch`)None
    ...
    deployment_users = sgqlc.types.Field(sgqlc.types.list_of('User'), graphql_name='deploymentUsers', args=sgqlc.types.ArgDict((
        ('deployment_id', sgqlc.types.Arg(sgqlc.types.non_null(Id), graphql_name='deploymentId', default=None)),
        ('user', sgqlc.types.Arg(UserSearch, graphql_name='user', default=None)),
))
    )
    ...
    * `user` (`UserSearch`): A `UserSearch` input type.
    ...
    deployment_variables = sgqlc.types.Field(sgqlc.types.list_of(EnvironmentVariable), graphql_name='deploymentVariables', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('release_name', sgqlc.types.Arg(String, graphql_name='releaseName', default=None)),
))
    )
    ...
    * `release_name` (`String`): A release name of a `Deployment`.
    ...
    invites = sgqlc.types.Field(sgqlc.types.list_of(Invite), graphql_name='invites', args=sgqlc.types.ArgDict((
        ('invite', sgqlc.types.Arg(InviteSearch, graphql_name='invite', default=None)),
))
    )
    ...
    * `invite` (`InviteSearch`): An `InviteSearch` input type.
    ...
    airflow_releases = sgqlc.types.Field(sgqlc.types.list_of(AirflowRelease), graphql_name='airflowReleases')

    card = sgqlc.types.Field(Card, graphql_name='card', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('stripe_customer_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='stripeCustomerId', default=None)),
))
    )
    ...
    * `stripe_customer_id` (`String!`):  A customer id in Stripe.
    ...
    workspace_invites = sgqlc.types.Field(sgqlc.types.list_of(Invite), graphql_name='workspaceInvites', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('invite', sgqlc.types.Arg(InviteSearch, graphql_name='invite', default=None)),
))
    )
    ...
    * `invite` (`InviteSearch`): An `InviteSearch` input type.
    ...
    workspace_deployments = sgqlc.types.Field(sgqlc.types.list_of(Deployment), graphql_name='workspaceDeployments', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('release_name', sgqlc.types.Arg(String, graphql_name='releaseName', default=None)),
))
    )
    ...
    * `release_name` (`String`): A release name of a `Deployment`.
    ...
    workspace_deployment = sgqlc.types.Field(Deployment, graphql_name='workspaceDeployment', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('release_name', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='releaseName', default=None)),
))
    )
    ...
    * `release_name` (`String!`): A release name of a `Deployment`.
    ...
    service_accounts = sgqlc.types.Field(sgqlc.types.list_of('ServiceAccount'), graphql_name='serviceAccounts', args=sgqlc.types.ArgDict((
        ('service_account_uuid', sgqlc.types.Arg(Uuid, graphql_name='serviceAccountUuid', default=None)),
        ('entity_type', sgqlc.types.Arg(sgqlc.types.non_null(EntityType), graphql_name='entityType', default=None)),
        ('entity_uuid', sgqlc.types.Arg(Uuid, graphql_name='entityUuid', default=None)),
))
    )
    ...
    * `entity_uuid` (`Uuid`)None
    ...
    workspace_service_accounts = sgqlc.types.Field(sgqlc.types.list_of('ServiceAccount'), graphql_name='workspaceServiceAccounts', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
))
    )
    ...
    * `workspace_uuid` (`Uuid!`): A `Workspace` id.
    ...
    workspace_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='workspaceServiceAccount', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
))
    )
    ...
    * `service_account_uuid` (`Uuid!`): A `ServiceAccount` id.
    ...
    workspace_users = sgqlc.types.Field(sgqlc.types.list_of('User'), graphql_name='workspaceUsers', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('user', sgqlc.types.Arg(UserSearch, graphql_name='user', default=None)),
))
    )
    ...
    * `user` (`UserSearch`): A `UserSearch` input type.
    ...
    workspace_user = sgqlc.types.Field('User', graphql_name='workspaceUser', args=sgqlc.types.ArgDict((
        ('workspace_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='workspaceUuid', default=None)),
        ('user', sgqlc.types.Arg(sgqlc.types.non_null(UserSearch), graphql_name='user', default=None)),
))
    )
    ...
    * `user` (`UserSearch!`): A `UserSearch` input type.
    ...
    deployment_service_account = sgqlc.types.Field('ServiceAccount', graphql_name='deploymentServiceAccount', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('service_account_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='serviceAccountUuid', default=None)),
))
    )
    ...
    * `service_account_uuid` (`Uuid!`): A `ServiceAccount` id.
    ...
    deployment_service_accounts = sgqlc.types.Field(sgqlc.types.list_of('ServiceAccount'), graphql_name='deploymentServiceAccounts', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
))
    )
    ...
    * `deployment_uuid` (`Uuid!`): A `Deployment` id.
    ...
    logs = sgqlc.types.Field(sgqlc.types.list_of(DeploymentLog), graphql_name='logs', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('component', sgqlc.types.Arg(String, graphql_name='component', default=None)),
...
class RoleBinding(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('id', 'role', 'user', 'service_account', 'workspace', 'deployment', 'created_at')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
...
class ServiceAccount(sgqlc.types.Type):
    __schema__ = houston_schema
    __field_names__ = ('id', 'api_key', 'label', 'category', 'entity_type', 'entity_uuid', 'workspace_uuid', 'deployment_uuid', 'active', 'last_used_at', 'created_at', 'updated_at', 'role_bindings')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
    ...
    role_bindings = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(RoleBinding))), graphql_name='roleBindings', args=sgqlc.types.ArgDict((
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
        ('before', sgqlc.types.Arg(RoleBindingWhereUniqueInput, graphql_name='before', default=None)),
        ('after', sgqlc.types.Arg(RoleBindingWhereUniqueInput, graphql_name='after', default=None)),
))
    )
    '''Arguments:
...
class Subscription(sgqlc.types.Type):
    ...
    deployment_status = sgqlc.types.Field(DeploymentStatus, graphql_name='deploymentStatus', args=sgqlc.types.ArgDict((
        ('release_name', sgqlc.types.Arg(String, graphql_name='releaseName', default=None)),
))
    )
    '''Arguments:
    ...
    * `release_name` (`String`)None
    ...
    log = sgqlc.types.Field(DeploymentLog, graphql_name='log', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('component', sgqlc.types.Arg(String, graphql_name='component', default=None)),
        ('timestamp', sgqlc.types.Arg(DateTime, graphql_name='timestamp', default=None)),
        ('search', sgqlc.types.Arg(String, graphql_name='search', default=None)),
    ...
    * `search` (`String`)None
    ...
    metrics = sgqlc.types.Field(sgqlc.types.list_of(Metric), graphql_name='metrics', args=sgqlc.types.ArgDict((
        ('deployment_uuid', sgqlc.types.Arg(sgqlc.types.non_null(Uuid), graphql_name='deploymentUuid', default=None)),
        ('metric_type', sgqlc.types.Arg(sgqlc.types.list_of(MetricType), graphql_name='metricType', default=None)),
...
class User(sgqlc.types.Type):
    ...
    __schema__ = houston_schema
    __field_names__ = ('id', 'username', 'emails', 'full_name', 'status', 'profile', 'created_at', 'updated_at', 'role_bindings')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
...
class Workspace(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('id', 'deployments', 'active', 'description', 'invites', 'properties', 'label', 'users', 'stripe_customer_id', 'role_bindings', 'workspace_capabilities', 'created_at', 'updated_at', 'trial_ends_at', 'billing_enabled', 'service_accounts', 'paywall_enabled')
    id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='id')
    ...
    role_bindings = sgqlc.types.Field(sgqlc.types.list_of(RoleBinding), graphql_name='roleBindings')

    workspace_capabilities = sgqlc.types.Field('WorkspaceCapabilities', graphql_name='workspaceCapabilities')
    '''An object containing various `Boolean`s indicating what the
...
class WorkspaceCapabilities(sgqlc.types.Type):
    ...
    '''
    __schema__ = houston_schema
    __field_names__ = ('can_update_billing', 'can_update_iam', 'can_update_workspace', 'can_delete_workspace', 'can_create_deployment', 'can_invite_user', 'can_update_user', 'can_delete_user', 'can_create_service_account', 'can_update_service_account', 'can_delete_service_account')
    ...
    can_create_deployment = sgqlc.types.Field(Boolean, graphql_name='canCreateDeployment')
