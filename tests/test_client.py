...
@pytest.mark.parametrize("actual,desired,expected_to_add,expected_to_delete,expected_to_update", compare_test_data)
def test_compare(actual, desired, expected_to_add, expected_to_delete, expected_to_update):
